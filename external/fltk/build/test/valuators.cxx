...
int main(int argc, char **argv) {
  ...
  { Fl_Double_Window* o = new Fl_Double_Window(580, 640, "Valuator classes, showing values for type()");
    ...
    { Fl_Group* o = new Fl_Group(10, 10, 280, 210, "Fl_Slider");
    ...
    { Fl_Group* o = new Fl_Group(10, 230, 280, 210, "Fl_Value_Slider");
      o->box(FL_ENGRAVED_BOX);
      o->labelfont(1);
      o->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
    ...
    { Fl_Group* o = new Fl_Group(10, 450, 135, 50, "Fl_Value_Input");
      o->box(FL_ENGRAVED_BOX);
      o->labelfont(1);
      o->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
    ...
    { Fl_Group* o = new Fl_Group(155, 450, 135, 50, "Fl_Value_Output");
      o->box(FL_ENGRAVED_BOX);
      o->labelfont(1);
    ...
    { Fl_Group* o = new Fl_Group(300, 10, 130, 120, "   Fl_Scrollbar");
      o->box(FL_ENGRAVED_BOX);
      o->labelfont(1);
    ...
    { Fl_Group* o = new Fl_Group(440, 10, 130, 120, "Fl_Adjuster");
      o->box(FL_ENGRAVED_BOX);
      o->labelfont(1);
      o->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
    ...
    { Fl_Group* o = new Fl_Group(300, 140, 130, 120, "Fl_Counter");
      o->box(FL_ENGRAVED_BOX);
      o->labelfont(1);
      o->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
    ...
    { Fl_Group* o = new Fl_Group(440, 140, 130, 120, "Fl_Spinner");
      o->box(FL_ENGRAVED_BOX);
      o->labelfont(1);
      o->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
    ...
    { Fl_Group* o = new Fl_Group(300, 270, 270, 105, "Fl_Dial");
      o->box(FL_ENGRAVED_BOX);
      o->labelfont(1);
      o->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
    ...
    { Fl_Group* o = new Fl_Group(300, 385, 150, 115, "Fl_Roller");
      o->box(FL_ENGRAVED_BOX);
      o->labelfont(1);
      o->align(Fl_Align(FL_ALIGN_TOP|FL_ALIGN_INSIDE));
...
"effect.");
    ...
    { Fl_Terminal* o = tty = new Fl_Terminal(10, 513, 560, 117);
      o->ansi(true);
    } // Fl_Terminal* tty
    o->end();
  } // Fl_Double_Window* o
